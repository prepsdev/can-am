                    ...
                    <div class="col-9">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a class="text-muted text-decoration-none">Customer</a>
                                </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea name="address" class="form-control" placeholder="Enter Address" rows="3" autocomplete="off">{{ $data->address }}</textarea>
                                @error('address')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>

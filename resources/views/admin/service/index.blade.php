    ...
    <div class="container-fluid">
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Service</h4>
        ...
        <div class="widget-content searchable-container list">
            ...
            <div class="col-md-12 col-xl-12 text-start d-flex justify-content-md-start justify-content-center my-3 mt-md-0">
                <a href="{{ route('admin.service.create') }}"class="btn btn-primary d-flex align-items-center">
                    <i class="ti ti-plus text-white me-1 fs-5"></i> Add Data
                </a>
            </div>
    ...
    <script>
        $(document).ready(function() {
            let table = $('#dataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.service.getData') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
